...
//alert('adWidth = '+width+ '\n Height = '+height);
   ...
   objectTag = '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="https://web.archive.org/web/20110128121854/http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0"';
   ...
   win.document.writeln('<embed src="'+src+'" loop="'+loop+'" play="'+play+'" width="'+width+'" height="'+height+'" type="application/x-shockwave-flash" pluginspage="https://web.archive.org/web/20110128121854/http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" />'); 
...
/*
     FILE ARCHIVED ON 12:18:54 Jan 28, 2011 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 14:06:28 Jul 30, 2019.
...
/*
playback timings (ms):
  LoadShardBlock: 81.716 (3)
  esindex: 0.008
  captures_list: 114.034
  CDXLines.iter: 11.888 (3)
  PetaboxLoader3.datanode: 106.235 (4)
  exclusion.robots: 0.241
  exclusion.robots.policy: 0.228
  RedisCDXSource: 17.166
  PetaboxLoader3.resolve: 68.836 (2)
  load_resource: 96.555
*/